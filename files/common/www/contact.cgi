...
<tr><th class="bubble">Koordinaten:&nbsp;</th><td>
 <i>Breitengrad:</i> $lat, <i>L&auml;ngengrad:</i> $long, <i>H&ouml;he:</i> $alt, <a href="http://www.openstreetmap.org/export/embed.html?bbox=$long,$lat,$long,$lat&layer=mapnik&marker=$lat,$long"><b>OpenStreetMap</b></a>, <a href="http://maps.google.de/maps?f=q&hl=de&q=$lat,$long&ie=UTF8&z=14&iwloc=addr&om=1"><b>Google Maps</b></a>
</td></tr>
