...
\begin{small} \begin{verbatim}
       --rt-table-offset <value> : set base routing table used by batmand.
          Configures table <value> to be used for <value+1> for host routes,
