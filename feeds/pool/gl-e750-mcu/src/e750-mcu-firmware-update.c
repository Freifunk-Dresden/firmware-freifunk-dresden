/*************************************************************************
	> File Name: e750-mcu-firmware-update.c
	> Author:lincoln
...
{
	printf("Usage:\n");
	printf("\te750-mcu-firmware-update file.bin\t--update mcu firmware\n");
	printf("\te750-mcu-firmware-update file.bin -r\t--Try again after update failed\n");
}
