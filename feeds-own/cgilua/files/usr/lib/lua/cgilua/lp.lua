...
--print("#compile: "..chunkname.."#"..s)
-- s="cgilua.put('<html><head></head><body>hallo</body></html>')" 
 f=loadstring(s)
...
function M.include (filename, env)
	...
	cgilua.loader= require "cgilua.loader"
	cgilua.post = require "cgilua.post"
	cgilua.session = require "cgilua.session"
	cgilua.cookies = require "cgilua.cookies"
	cgilua.readuntil = require "cgilua.readuntil"
	cgilua.urlcode = require "cgilua.urlcode"
	cgilua.dispatcher = require "cgilua.dispatcher"
	cgilua.mime = require "cgilua.mime"
	cgilua.serialize = require "cgilua.serialize"
